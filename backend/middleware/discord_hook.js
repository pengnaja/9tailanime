...
function sendWebhookMessage(title,author_image) {
  ...
  const embed = new MessageBuilder()
    .setTitle(title)
    .setAuthor('9TAIL-MANGA', 'https://sv3.9tailmanga.com/thumbnails/9TAILMANGA-B%20(2).png', process.env.WEB_FRONT)
...
console.log(`CPU Cores: ${cpuCores}`);
  ...
  const embed = new MessageBuilder()
    ...
    .setAuthor('9TAIL-ANIME', 'https://sv3.9tailmanga.com/thumbnails/9TAILMANGA-B%20(2).png', process.env.WEB_FRONT)
    .setURL(process.env.WEB_BACKEND)
    .setColor('#6c2bd9')
    .setTimestamp();
